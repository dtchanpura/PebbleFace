...
static void main_window_load(Window *window) {
	...
	//text_layer_set_text_color(s_background_layer,GColorClear);

	//bitmap_layer_set_bitmap(s_background_layer, s_background_bitmap);
	//layer_add_child(window_get_root_layer(window), bitmap_layer_get_layer(s_background_layer));

	// Create time TextLayer
	s_time_layer = text_layer_create(GRect(0, 0, 144, 64));
	...
	//Create GFont
	s_time_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_LATO_BOLD_42));
	...
	/////////////////////////////////////////////////
	s_date_layer = text_layer_create(GRect(0,64, 144, 36));
